                ...
                <Modal.Body>
                    <div className="space-y-6">
                        <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                            By removing the selected items, you will lose all
                            the data associated with them. This action cannot be
                            undone.
                        </p>
                    </div>
                </Modal.Body>
                ...
                {stats.totalPages > 1 && (
                    ...
                    >
                        <Pagination
                            ...
                            onPageChange={
                                isDeleting ? (_page) => null : changePage
                            }
                        />
                    </nav>
                )}
